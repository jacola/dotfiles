...
alias aws-get-t2='export instanceId=`aws ec2 describe-instances --filters "Name=instance-state-name,Values=stopped,Name=instance-type,Values=t2.large" --query "Reservations[0].Instances[0].InstanceId"` && export instanceId=${instanceId//\"/} && echo $instanceId'
...
export instanceId=i-0e3c2cdff89600226
